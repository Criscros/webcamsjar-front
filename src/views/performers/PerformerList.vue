...
<template>
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="performers">
      ...
      <template slot="thead">
        <vs-th sort-key="name">Nick</vs-th>
        <vs-th sort-key="category">Active</vs-th>
        <vs-th sort-key="category">Front_document</vs-th>
        <vs-th sort-key="price">Back_document</vs-th>
        <vs-th>Details</vs-th>
      ...
      <template slot-scope="{data}">
        <tbody>
          <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
            ...
            <vs-td>
              <p class="product-name font-medium truncate">{{ tr.nick }}</p>
            </vs-td>
            ...
            <vs-td>
              <p class="product-category">{{ tr.front_document }}</p>
            </vs-td>

            <vs-td>
              <p class="product-price">{{ tr.back_document }}</p>
            </vs-td>

            <vs-td class="whitespace-no-wrap">
              <vs-button :color="colorx" @click="detilsPerfomer(tr._id)" type="filled"><feather-icon icon="EyeIcon"/>
              </vs-button>
            </vs-td>

            <vs-td class="whitespace-no-wrap">
              <vs-button :color="colorx" @click="deleteData(tr._id)" type="filled">
