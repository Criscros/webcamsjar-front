      ...
      <vx-card title="AGREGAR SEDE" >
        ...
        <div class="vx-row mb-6">
          <div class="vx-col w-full">
            ...
            <!-- <vs-input class="w-full" v-model="web_whatsapp" type="email" label="WEB WHATSS APP" /> -->
          </div>
        </div>
        <div class="vx-row mb-6">
          <div class="vx-col w-full">
        ...
        <div class="vx-row mb-6">
            <div class="vx-col w-full">
                ...
                <ul class="centerx">
                  <li>                    <vs-checkbox v-model="gender.woman">Mujeres</vs-checkbox>
                  </li>
                  <li>
        ...
        <vs-button color="success" type="filled" @click="SaveHeadQuarter">Guardar</vs-button>
...
import GoogleMapBasic from './SucursalMap.vue'
  ...
  data () {
    ...
    methods:{
         ...
         SaveHeadQuarter(){
          ...
          if(this.name != '' && this.email != '' && payload.lat_lng != '' && this.department_selected != '' && this.city_selected){

              this.$store.dispatch('headquarterList/saveHeadquarter', payload).then((msg)=>{
