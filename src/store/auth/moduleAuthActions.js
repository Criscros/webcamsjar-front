...
export default {
        ...
        .then(response => {
          ...
          if (response.data.success) {
            ...
            store.commit('UPDATE_USER_INFO', {
              ...
              userRole:response.data.userData.role
            })
            
            console.log("ESTADO LOGIN", store)
  ...
  registerUserJWT ({ commit }, payload) {
    ...
    const { displayName, email, password, confirmPassword, rol } = payload.userDetails
    return new Promise((resolve, reject) => {
      ...
      jwt.registerUser(displayName, email, password , rol)
        .then(response => {
          ...
          if(response.data.success ){
            ...
            localStorage.setItem('studio_id', response.data.userData.studio_id)
  ...
  getDepartmentCities({commit}, data){
    commit('SET_BEARER', '')
    return new Promise((resolve, reject) => {
      // Check confirm password
      jwt.departmentsCities(data)
        .then(response => {
            resolve(response)
        })
        .catch(error => { reject(error) })
